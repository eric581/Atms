...
import com.atms.common.shiro.MyJdbcAuthzService;
import com.atms.common.shiro.jar.core.handler.*;
...
public class ShiroPlugin implements IPlugin {
     ...
     * jdbc的权限加载器
     */
    private JdbcAuthzService jdbcAuthzService = new MyJdbcAuthzService();
